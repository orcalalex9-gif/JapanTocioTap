...
weapons = {
    # ===== ОРУЖИЕ =====
    'barret_m82': {'name': 'Barret M82', 'price': 2500000, 'stock': 1, 'category': 'Оружие'},
    'm4a1': {'name': 'M4A1', 'price': 1100000, 'stock': 12, 'category': 'Оружие'},
    'svd': {'name': 'CВД', 'price': 1100000, 'stock': 3, 'category': 'Оружие'},
    'ak74': {'name': 'AK-74', 'price': 1100000, 'stock': 32, 'category': 'Оружие'},
    'mp5': {'name': 'MP5', 'price': 550000, 'stock': 15, 'category': 'Оружие'},
    'aks74u': {'name': 'AKC-74У', 'price': 550000, 'stock': 8, 'category': 'Оружие'},
    'pb_silencer': {'name': 'ПБ (c глyшитeлeм)', 'price': 400000, 'stock': 6, 'category': 'Оружие'},
    'remington870': {'name': 'Remington 870', 'price': 350000, 'stock': 10, 'category': 'Оружие'},
    'glock17': {'name': 'Glock-17', 'price': 200000, 'stock': 45, 'category': 'Оружие'},
    'glock18': {'name': 'Glock-18', 'price': 180000, 'stock': 14, 'category': 'Оружие'},
    'kedr': {'name': 'Кeдp (ПП-91)', 'price': 180000, 'stock': 9, 'category': 'Оружие'},
    'tt': {'name': 'ТТ', 'price': 100000, 'stock': 20, 'category': 'Оружие'},
    'pm': {'name': 'ПM', 'price': 56000, 'stock': 50, 'category': 'Оружие'},
    'obrez': {'name': 'Обpeз', 'price': 56000, 'stock': 25, 'category': 'Оружие'},
    'silencer': {'name': 'Глyшитeль 9x19', 'price': 56000, 'stock': 30, 'category': 'Оружие'},
    'grenade': {'name': 'Гpaнaтa Ф-1', 'price': 8000, 'stock': 120, 'category': 'Оружие'},

    # ===== ДОКУМЕНТЫ =====
    'digital_scan': {'name': 'Цифровой скан', 'price': 1000, 'stock': None, 'category': 'Документы'},
    'personal_data': {'name': 'Данные личности', 'price': 5000, 'stock': None, 'category': 'Документы'},
    'drivers_license': {'name': 'Права (пластик)', 'price': 37000, 'stock': None, 'category': 'Документы'},
    'passport_rf': {'name': 'Паспорт РФ', 'price': 125000, 'stock': None, 'category': 'Документы'},
    'foreign_passport_no_chip': {'name': 'Зарубежка (без чипа)', 'price': 250000, 'stock': None, 'category': 'Документы'},
    'foreign_passport_chip': {'name': 'Зарубежка (с чипом)', 'price': 650000, 'stock': None, 'category': 'Документы'},

    # ===== ХИМИЯ =====
    'marijuana': {'name': 'Марихуана', 'price': 1500, 'stock': None, 'category': 'Химия'},
    'hashish': {'name': 'Гашиш', 'price': 2000, 'stock': None, 'category': 'Химия'},
    'methamphetamine': {'name': 'Метамфетамин', 'price': 3500, 'stock': None, 'category': 'Химия'},
    'cocaine': {'name': 'Кокаин', 'price': 7000, 'stock': None, 'category': 'Химия'},

    # ===== АВТО-УГОН =====
    'simple_signs': {'name': 'Простые знаки', 'price': 7000, 'stock': None, 'category': 'Авто-угон'},
    'elite_duplicates': {'name': 'Элитные дубликаты', 'price': 10000, 'stock': None, 'category': 'Авто-угон'},
    'lockpick_kit': {'name': 'Комплект отмычек и сканер', 'price': 25000, 'stock': 15, 'category': 'Авто-угон'},
    'anti_tracker': {'name': 'Программа-антитрекер', 'price': 50000, 'stock': 8, 'category': 'Авто-угон'},

    # ===== СВЯЗЬ И СПЕЦСРЕДСТВА =====
    'burner_phone': {'name': 'Одноразовый телефон (Burner Phone)', 'price': 7000, 'stock': 25, 'category': 'Связь'},
    'jammer': {'name': 'Портативная глушилка сигнала', 'price': 85000, 'stock': 5, 'category': 'Связь'},

    # ===== УСЛУГИ =====
    'sportiki': {'name': 'Спортики (Силовой выезд)', 'price': 100000, 'stock': None, 'category': 'Услуги'},

    # ===== РАСТЕНИЯ =====
    'seeds_weed': {'name': 'Семена марихуаны (10 шт.)', 'price': 3500, 'stock': None, 'category': 'Растения'},
    'seeds_coca': {'name': 'Семена коки (10 шт.)', 'price': 10000, 'stock': None, 'category': 'Растения'},
    'soil': {'name': 'Грунт для выращивания (мешок)', 'price': 2000, 'stock': None, 'category': 'Растения'},
    'fertilizer': {'name': 'Удобрения (комплект)', 'price': 5500, 'stock': None, 'category': 'Растения'},
    'lamp': {'name': 'Лампа для рассады (LED)', 'price': 8000, 'stock': None, 'category': 'Растения'},
    'drip_system': {'name': 'Система полива (капельная)', 'price': 12000, 'stock': None, 'category': 'Растения'},
    'ventilation': {'name': 'Вентиляция (комплект)', 'price': 17000, 'stock': None, 'category': 'Растения'},
    'carbon_filter': {'name': 'Фильтр для воздуха (угольный)', 'price': 10000, 'stock': None, 'category': 'Растения'},
    'hydroponics': {'name': 'Гидропонная установка', 'price': 24000, 'stock': None, 'category': 'Растения'},
    'dryer': {'name': 'Сушилка для шишек', 'price': 14000, 'stock': None, 'category': 'Растения'},
}
